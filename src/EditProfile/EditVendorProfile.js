...
function EditVendorProfile({ vendor }) {
  ...
  function handleSubmit(e){
    ...
    // axios.post("http://localhost:8080/edit/vendor", vendorDto)
  ...
  return (
    <div className="container-fluid">
      ...
      <Grid xs={12} sm={6} item>
        ...
        <Grid item xs={12}>
            <MultipleSelectChip vendorServices={vendor.services} editToggle={editToggle} setSelectedServiceArr={setSelectedServiceArr}/>
        </Grid>
        ...
        <Select label="City" disabled={editToggle} style={{ minWidth: 120 }} name="city" defaultValue={vendor.city} onChange={()=> setFormEdited(true)}>
          {cityList.map((item) => {
